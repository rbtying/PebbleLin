...
public class MidiFile {
  ...
  static final int header[] = new int[] { 0x4d, 0x54, 0x68, 0x64, 0x00, 0x00, 0x00, 0x06, 0x00,
          0x00, // single-track format
          0x00, 0x01, // one track
  ...
  static final int tempoEvent[] = new int[] { 0x00, 0xFF, 0x51, 0x03, 0x0F, 0x42, 0x40 // Default 1
                                                                                       // million
                                                                                       // usec per
                                                                                       // crotchet
  };
  ...
  /**
   * Convert an array of integers which are assumed to contain unsigned bytes into an array of bytes
   */
  ...
  /**
   * Store a note-on event followed by a note-off event a note length later. There is no delta value
   * — the note is assumed to follow the previous one with no gap.
   */
  ...
  public static void main(String[] args) throws Exception {
    ...
    int[] sequence = new int[] { 60, QUAVER + SEMIQUAVER, 65, SEMIQUAVER, 70, CROTCHET + QUAVER,
            69, QUAVER, 65, QUAVER / 3, 62, QUAVER / 3, 67, QUAVER / 3, 72, MINIM + QUAVER, -1,
            SEMIQUAVER, 72, SEMIQUAVER, 76, MINIM, };
